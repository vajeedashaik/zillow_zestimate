...
import { predict, type PredictionResult } from '@/lib/mockPredictor';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div className="lg:col-span-2">
              <label className="block text-xs text-gray-400 mb-1.5 font-medium">
                Zillow Zestimate ($)
                <span className="ml-1 text-gray-600">— for true value range</span>
              </label>
              <input
                type="number"
            ...
            <div className="lg:col-span-2">
              ...
              <select
                value={form.county}
                onChange={(e) => handleChange('county', e.target.value as County)}
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:border-amber-500/50 transition-colors"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => handleChange('transactionMonth', Number(e.target.value))}
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:border-amber-500/50 transition-colors"
              >
                {MONTH_NAMES.map((m, i) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                ...
                <ResponsiveContainer width="100%" height={160}>
                  <BarChart
                    layout="vertical"
                    data={result.shapValues.slice(0, 3)}
